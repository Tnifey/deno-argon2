import { argon2, Command, encode } from "../deps.ts";
...
export let hash = new Command()
  ...
  .type(
    "thread-mode",
    (option: { name: unknown }, _: unknown, value: unknown) => {
      switch (value) {
        case "sequential": {
  ...
  .type("variant", (option: { name: unknown }, _: unknown, value: unknown) => {
    switch (value) {
  ...
  .type(
    "json",
    (option: { name: unknown }, _: unknown, value: string | undefined) => {
      try {
        if (value !== undefined) {
